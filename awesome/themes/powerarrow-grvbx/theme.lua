...
local device_ethernet   = "enp3s0"
local device_wifi       = "tun0"
...
-- fonts
local theme_font_type                       = "OperatorMonoLigBook"
local theme_font_size                       = "12"
local hotkeys_font_type                     = "OperatorMonoLigBook"
local hotkeys_font_size                     = "12"
