...
theme.mail = lain.widget.imap({
    timeout  = 180,
    server   = "imap.privat.bahnhof.se",
    mail     = "fuzebox@bahnhof.se",
    password = "budw3iser..",
    settings = function()
        if mailcount > 0 then
...
-- MPD -- I dont use mpd. adding spotify under
--[[
...
-- Coretemp -- doesnt seem to work... doesnt update.
...
-- theme.fs = lain.widget.fs({
    -- notification_preset = { fg = theme.fg_normal, bg = theme.bg_normal, font = "Operator Mono Lig Book 11" },
    -- settings = function()
...
--[[ ALSA volume ------------- Using the below widget instead.
...
--            wibox.container.background(theme.mpd.widget, theme.bg_focus),
            ...
            wibox.container.background(volumebar_widget({
                ...
                mute_color = '#FB4934',
                width = 50,
                shape = 'powerline', -- octogon, hexagon, powerline, etc
            ...
            temp,
            arrl_ld,
--            storage_widget({ mounts = { '/', '/media/hdd' } }), --Broken?
--            arrl_dl,
            --baticon,
            --bat.widget,
            --arrl_ld,
